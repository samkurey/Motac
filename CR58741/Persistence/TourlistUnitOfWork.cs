...
namespace TourlistDataLayer.Persistence
{
    public class TourlistUnitOfWork
    {
        ...
        public TourlistUnitOfWork(TourlistContext context)
        {
            ...
            MM2HAddBranchesUpdatedRepository = new MM2HAddBranchesUpdatedRepository(context); //added by samsuri (CR#58741) on 26 Jan 2024
            ...
            CoreLicenseUpdatedRepository = new CoreLicenseUpdatedRepository(context);
        }
        ...
        public MM2HAddBranchesUpdatedRepository MM2HAddBranchesUpdatedRepository { get; private set; } //added by samsuri (CR#58741) on 26 Jan 2024
        ...
        public CoreLicenseUpdatedRepository CoreLicenseUpdatedRepository { get; set; }
